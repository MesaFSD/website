  ...
  return (
    <div className="z-10 col-start-1 row-start-1 flex items-center justify-center">
      <motion.div
        ...
        className="flex size-10 items-center justify-center rounded-full bg-linear-to-t from-green-500 to-green-300 shadow-sm"
      >
        <PhoneIcon className="size-7 fill-white" />
      </motion.div>
    </div>
  )
}
  ...
  return (
    <div className="z-10 col-start-1 row-start-1">
      <div className="mx-auto flex size-full max-w-md items-center justify-around">
        <img
          alt="Antoine Bonhomme"
          src="/team/antoine-bonhomme.jpeg"
          className="size-20 rounded-full bg-white/15 object-cover ring-4 ring-white/10"
        />
        <img
          alt="Aiden Tabrizi"
          src="/team/aiden-tabrizi.png"
          className="size-20 rounded-full bg-white/15 object-cover ring-4 ring-white/10"
        />
      </div>
    </div>
