...
function Marker({
  ...
  return (
    <div
      ...
      className="absolute left-[calc(50%+var(--offset))] size-[38px] drop-shadow-[0_3px_1px_rgba(0,0,0,.15)] transition-transform duration-500 ease-in-out group-hover:animate-marker-pulse"
    >
  ...
  return (
    <div aria-hidden="true" className="relative size-full">
      ...
      <div className="absolute inset-0">
        <Marker src="/map/ucsd.png" top={182} offset={-93} />
        <Marker src="/map/aks.svg" top={104} offset={15} />
      </div>
    </div>
  )
}
